...
| Мёртвый (пред.) | Не работающий, сломанный пред. |
| Протрузия | Казус/проблема/пробой |
| Подтрунивает | Неравномерно работает |
| Фуклюмзия | Фрустрация / несоответствие |
| Профурсетка | Девушка лёгкого поведения |
| Шуфлядка | Выдвижной ящик или комод |
